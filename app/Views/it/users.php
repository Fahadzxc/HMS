...
<div id="addUserModal" class="modal" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="addUserTitle">
        ...
        <form id="addUserForm" class="modal-body" action="<?= base_url('it/users/create') ?>" method="post">
            <?= csrf_field() ?>
            <div class="form-grid">
...
<div id="editUserModal" class="modal" aria-hidden="true" style="display:none;">
    ...
    <div class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="editUserTitle">
        ...
        <form id="editUserForm" class="modal-body" action="<?= base_url('it/users/update') ?>" method="post">
            <?= csrf_field() ?>
...
function deleteUser(userId) {
    if (confirm('Are you sure you want to delete this user? This action cannot be undone.')) {
        ...
        form.method = 'POST';
        form.action = '<?= base_url('it/users/delete') ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Role change handler for License ID field
    const roleSelect = document.getElementById('add_role');
    if (roleSelect) {
        roleSelect.addEventListener('change', toggleLicenseIdField);
    }
